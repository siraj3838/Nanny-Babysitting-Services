            ...
            <div className="max-w-screen-xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-8 pb-10 px-6 lg:px-0">
                    <div className="grid grid-cols-3 gap-3 border p-4 rounded h-48" data-aos="fade-down-right" data-aos-duration="2200">
                        ...
                        <div className="bg-pink-500 text-white col-span-2 p-4 space-y-2">
                            <h2 className="text-xl lg:text-2xl font-semibold">Join the Network</h2>
                    ...
                    <div className="grid grid-cols-3 gap-3 border p-4 rounded h-48" data-aos="fade-down-left" data-aos-duration="2200">
                        ...
                        <div className="bg-[#52a21dc1] text-white col-span-2 p-4 space-y-2">
                            <h2 className="text-xl lg:text-2xl font-semibold">Childcare</h2>
                    ...
                    <div className="grid grid-cols-3 gap-3 border p-4 rounded h-48" data-aos="fade-up-right" data-aos-duration="2200">
                        ...
                        <div className="bg-[#01c067be] text-white col-span-2 p-4 space-y-2">
                            <h2 className="text-xl lg:text-2xl font-semibold">Advertise with us</h2>
                            <p>Chicco provides helpful articles for parents on infant and toddler car seats, strollers, child safety
</p>
                        </div>
                    </div>
                    <div className="grid grid-cols-3 gap-3 border p-4 rounded h-48" data-aos="fade-up-left" data-aos-duration="2200">
                        ...
                        <div className="bg-[#e6a822] text-white col-span-2 p-4 space-y-2">
                            <h2 className="text-xl lg:text-2xl font-semibold">Parents Forum</h2>
                            <p>Our Child Development Experts Have Worked With Thousands Of Parents On Various Challenges.</p>
                        </div>
                    </div>
